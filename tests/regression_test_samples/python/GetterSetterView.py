...
# Purpose:     Models the View component of the applications' MVC architecture.
#              This class is responsible for graphically displaying the state
#              of the application by reacting to messages from the Model
#              compenent.
#
# Author:      Soribo
#
...
class GetterSetterView( wx.Frame ):
    ...
    def init_io_panel( self ):
        ...
        io_sizer.Add( self.output_eb, 1, wx.EXPAND, 10 )


        io_panel.SetSizer( io_sizer )
        self.main_sizer.Add( io_panel, 3, wx.EXPAND | wx.ALL, 10 )
    ...
    def init_button_panel_ex( self ):
        ...
        attrib_sizer     = wx.StaticBoxSizer( attrib_box, wx.HORIZONTAL )
        ...
        input_panel           = wx.Panel( control_panel, wx.ID_ANY )
        ...
        self.save_output_file = wx.Button( control_panel, wx.ID_ANY, "Save Output", size = (-1,20) )
    ...
    def display_variables( self, var_list ):
        ...
        for variable in var_list:
            ...
            row_items = ( variable.var_name,
                          ...
                          # "Not Implemented yet" )  # GenerationTypeChooser( self, -1, "None", variable_index ) )
